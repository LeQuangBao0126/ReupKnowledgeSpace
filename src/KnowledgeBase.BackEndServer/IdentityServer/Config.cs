    ...
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> Apis =>
           new ApiResource[]
           {
                new ApiResource()
                {
                    DisplayName = "Knowledge Base Api Resource",
                    Name = "api.knowledgespace",
                    Scopes=  new Scope[]
                    {
                        new Scope("api.knowledgespace","knowledgespace")
                    }
                }
           };
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                {
                    ClientId = "webportal",
                    ClientSecrets = { new Secret("secretsecretsecret".Sha256()) },
                ...
                new Client
                {
                    ...
                    AllowedScopes = new List<string>
                    {
                        IdentityServerConstants.StandardScopes.OpenId,
                        IdentityServerConstants.StandardScopes.Profile,
                        "api.knowledgespace","offline_access"
                    }
                    ,
                    AllowOfflineAccess= true
                }
