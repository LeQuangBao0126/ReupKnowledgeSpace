...
import { KnowledgeBase, Pagination } from '@app/shared/models';
...
export class KnowledgeBasesComponent implements OnInit, OnDestroy {
  ...
  showAddModal() {
    this.router.navigateByUrl('/contents/kbs-detail/');
  }
  showEditModal() {
    ...
    this.router.navigateByUrl('/contents/kbs-detail/' + this.selectedItems[0].id);
  }
